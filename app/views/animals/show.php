            ...
            <div class="dashboard-card fade-in">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title mb-0">
                        <i class="fas fa-paw me-2"></i>Animal: <?php echo htmlspecialchars($animal['animal_name'] ?? 'Unknown'); ?>
                    </h4>
                    <div class="btn-group">
                ...
                <div class="card-body">
                    <div class="row">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-8"><?php echo htmlspecialchars($animal['animal_name'] ?? 'Not specified'); ?></div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-4 fw-bold">Species/Breed:</div>
                                        <div class="col-sm-8">
                                            <?php echo htmlspecialchars($animal['species'] ?? 'Not specified'); ?>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-8"><?php echo !empty($animal['weight']) ? $animal['weight'] . ' kg' : 'Not specified'; ?></div>
                                    </div>
                                    <div class="row mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <span class="badge <?php echo ($animal['animal_status'] ?? '') == 'active' ? 'bg-success' : 'bg-warning'; ?>">
                                                <?php echo ucfirst($animal['animal_status'] ?? 'Unknown'); ?>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <?php if (isset($animal['client_full_name'])): ?>
                                        <div class="row mb-3">
                                            <div class="col-sm-4 fw-bold">Name:</div>
                                            <div class="col-sm-8"><?php echo htmlspecialchars($animal['client_full_name']); ?></div>
                                        </div>
                                    <?php endif; ?>
                                    
                                    <?php if (isset($animal['client_email'])): ?>
                                        <div class="row mb-3">
                                            <div class="col-sm-4 fw-bold">Email:</div>
                                            <div class="col-sm-8"><?php echo htmlspecialchars($animal['client_email']); ?></div>
                                        </div>
                                    <?php endif; ?>
                            ...
                            <div class="card mb-4">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Assigned Veterinary</h5>
                                </div>
                                <div class="card-body">
                                    <?php if (isset($animal['vet_full_name'])): ?>
                                        <div class="row mb-3">
                                            <div class="col-sm-4 fw-bold">Name:</div>
                                            <div class="col-sm-8"><?php echo htmlspecialchars($animal['vet_full_name']); ?></div>
                                        </div>
                                    <?php endif; ?>
                                    
                                    <?php if (isset($animal['vet_email'])): ?>
                                        <div class="row mb-3">
                                            <div class="col-sm-4 fw-bold">Email:</div>
                                            <div class="col-sm-8"><?php echo htmlspecialchars($animal['vet_email']); ?></div>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Recent Vaccinations</h5>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-sm">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo htmlspecialchars($vaccine['administered_by_name'] ?? 'Unknown'); ?></td>
                                                </tr>
                                                <?php endforeach; ?>
                                            </tbody>
                                        </table>
                                    </div>
                                    <?php if (count($vaccines) > 5): ?>
                                        <div class="text-center mt-3">
                                            <a href="<?php echo url('/animals/' . $animal['animal_id'] . '/medical-history'); ?>" 
                                               class="btn btn-outline-primary btn-sm">
                                                View All Vaccinations (<?php echo count($vaccines); ?>)
                                            </a>
                                        </div>
                                    <?php endif; ?>
                                </div>
