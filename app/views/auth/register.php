<?php
$this->layout = null; // No layout for standalone page
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Client Registration - Veterinary Health Management System</title>
            ...
            <div class="row g-0 h-100">
                ...
                <div class="col-md-5 left-panel">
                    <div class="logo-container">
                        <div class="logo">
                            <img src="<?= asset('img/vet-logo.png') ?>" alt="VetCare Pro Logo" style="width:200px; height:200px; object-fit:contain;">
                        </div>
