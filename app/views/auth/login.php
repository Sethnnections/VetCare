<?php
// This file should ONLY contain the login form HTML and PHP logic
    ...
    <div class="login-card">
        <div class="row g-0 h-100">
            ...
            <div class="col-md-6 right-panel">
                ...
                <form method="POST" action="<?php echo url('/authenticate'); ?>" id="loginForm">
                    ...
                    <div class="forgot-password">
                        <a href="<?php echo url('/auth/forgot-password'); ?>" id="forgotPassword">Forgot your password?</a>
                    </div>

                    <?php if (ENABLE_REGISTRATION): ?>
                    <a href="<?php echo url('/register'); ?>" class="register-btn">
